...
typedef enum {SUCCESS = 0, FAIL = 1, BAD_HASHLEN = 2} JHHashReturn;

JHHashReturn jh_hash(int hashbitlen, const BitSequence *data, DataLength databitlen, BitSequence *hashval);

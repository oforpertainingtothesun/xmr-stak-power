...
/*The API functions*/
static JHHashReturn Init(hashState *state, int hashbitlen);
static JHHashReturn Update(hashState *state, const BitSequence *data, DataLength databitlen);
static JHHashReturn Final(hashState *state, BitSequence *hashval);
